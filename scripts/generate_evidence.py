...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate and validate evidence for governance-capture-01")
    ...
    evidence = {
        ...
        "assertions": {
            "exploitConfirmed": "testGovernanceCaptureOnVulnerable" in output,
            "fixConfirmed": "testDoubleVoteBlockedOnFixed" in output,
            "negativeControlConfirmed": "testNegativeControlHonestMultiVoterExecution" in output,
        },
